...
var MT = React.createClass({
    render: function () {
        return (
            <View style={{}}>
                <View style={[styles.height160,styles.row]}>
                    <View style={[styles.height160, styles.part_1_left]}>
                        <Text style={[styles.font14,styles.marTop18, styles.marLeft10, styles.green]}>我们111约会吧</Text>
                        <Text style={[styles.font14,styles.marTop18, styles.marLeft10, ]}>恋爱家人好朋友</Text>
                    ...
                    <View style={[styles.height160, styles.part_1_right]}>
                        <View style={[styles.row,{flex:1}]}>
                            <View style={{flex:1}}>
                                ...
                                <Text
                                    style={[styles.font14,{fontSize:12,marginTop:14,marginLeft:30,color:'black'}]}>十元</Text>
                            </View>
                            <View style={{flex:1}}>
                        ...
                        <View style={[{flex:1, flexDirection:'row',borderTopWidth:1,borderColor:'#DDD8CE'}]}>
                            <View style={[{flex:1,borderRightWidth:1,borderColor:'#DDD8CE', flexDirection:'column'}]}>
                                <Text style={{color:'#f742AB',marginLeft:5, fontWeight:'bold',fontSize:15,marginTop:8}}>聚餐宴请</Text>
                                <Text style={{fontSize:12,marginTop:4,marginLeft:5}}>朋友家人常聚会</Text>
                ...
                <View style={{flexDirection:'row',}}>
                    <View style={{flexDirection:'row',flex:1,borderColor:'#DDD8CE',borderRightWidth:1}}>
